                  ...
                  <div key={req.id} className="p-5 hover:bg-indigo-50/5 transition-colors">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className={`px-3 py-1.5 text-[10px] font-black rounded-xl uppercase tracking-wider border shadow-sm
                        ${req.status === 'approved' ? 'bg-green-50 text-green-700 border-green-100 shadow-green-100/50' : 
                          req.status === 'rejected' ? 'bg-red-50 text-red-700 border-red-100 shadow-red-100/50' : 
                          req.status === 'submitted' ? 'bg-blue-50 text-blue-700 border-blue-100 shadow-blue-100/50' : 
